...
ALTER TABLE tournaments
ADD CONSTRAINT fk_tournaments
FOREIGN KEY (genre_id)
REFERENCES categories(genre_id);

ALTER TABLE tournament_participants
ADD CONSTRAINT fk_tournament_participants
...
ALTER TABLE game_participants
ADD CONSTRAINT fk_game_participants
FOREIGN KEY (game_id)
REFERENCES games(game_id)
ADD CONSTRAINT fk_game_participants
...
ALTER TABLE statistics
ADD CONSTRAINT ck_game_WLD
>>>>>>> 282d9ca8ace896907acf8849c6a110bbab267d2d
